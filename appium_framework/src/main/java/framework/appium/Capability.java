...
public class Capability {
	...
	public AppiumDriverLocalService startServer()
	{
		...
		if(!flag)
		{
			service = AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
	                ...
	                .withAppiumJS(new File("C:\\Users\\ArigelaAvanti\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
	...
	//this is socket programming. this is basically to check if the port is in use.if it is it will kill,else it will start
